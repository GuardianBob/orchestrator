...
// ── Static reasons — TASK-014 commit-deltas (3) ─────────────────────────────
export const REASON_COMMIT_OK            = 'commit-ok';
export const REASON_COMMIT_NO_CHANGES    = 'commit-no-changes';
export const REASON_COMMIT_NOT_ATTEMPTED = 'commit-not-attempted';
...
// ── Builders — TASK-014 commit-deltas (3) ───────────────────────────────────
export const reasonCommitAddFailed  = (code) => `commit-add-failed:${code}`;
export const reasonCommitDiffFailed = (code) => `commit-diff-failed:${code}`;
export const reasonCommitFailed     = (code) => `commit-failed:${code}`;
